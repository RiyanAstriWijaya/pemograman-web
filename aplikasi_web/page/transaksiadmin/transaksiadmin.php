...
<div class="row">
	...
	$query=mysqli_query($koneksi, "SELECT a.harga, a.jumlah, a.tanggal, a.total, c.username, c.no_hp, b.nama_buah FROM transaksi_fix as a JOIN barang as b ON a.id_buah=b.id_buah JOIN username as c ON a.id_username=c.id_user");
	$no=1;
